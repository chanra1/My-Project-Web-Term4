...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12 title">
			<h1><i class="fa fa-bars"></i> Advertising </h1>
		</div>
        <div class="col-lg-12">
            @if ($errors->any())
		...
		<div class="col-sm-4 cat-form">
			...
			@endif
            <h3>Add New Advertising</h3>


			<form method="post" action="{{ asset('/admin/advertising/store') }}" enctype="multipart/form-data">
				{{ csrf_field() }}
                ...
                <br>
				<div class="form-group">
					<button class="btn btn-primary">Add New Advertising</button>
				</div>
			</form>
		</div>
